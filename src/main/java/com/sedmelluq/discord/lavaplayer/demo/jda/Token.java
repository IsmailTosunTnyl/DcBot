...
public class Token {
    private static final String TOKEN="Nzc1MzUwMDM3NjQyMjE1NDQ1.X6lC_g.V9_zd5U2zupjuTLNc1uLDJAmQsw";
    private static final DSes[] dsesArray={
    ...
    public static DSes[] getDsesArray() {
        return dsesArray;
    }
}
